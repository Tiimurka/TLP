...
enum AST_ID {AST_PROG = 0, AST_PRE, AST_VAR, AST_VAR_IDS, AST_VAR_DECL, AST_DECL_ARRAY, AST_FUNC_DECL, AST_ARR,
 ...
 AST_TYPE_NUM, AST_TYPE_ID, AST_TYPE_STRING, AST_BINOP_PLUS, AST_BINOP_MINUS, AST_BINOP_SLASH, AST_BINOP_ASTER, AST_BINOP_DIV, AST_BINOP_MOD,
 AST_LOGIC_ISEQUAL, AST_LOGIC_ISNOTEQUAL, AST_LOGIC_ISLESS, AST_LOGIC_ISMORE, AST_LOGIC_OR, AST_LOGIC_AND,
