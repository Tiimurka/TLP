...
enum AST_ID {AST_PROG = 0, AST_PRE, AST_VAR, AST_VAR_IDS, AST_VAR_DECL, AST_DECL_ARRAY, /*AST_VAR_TYPES,*/
 AST_MAIN, AST_FUNC, AST_F_BODY, AST_F_CONT, AST_ARG, AST_ASSIGN, AST_CHOICE, AST_IF,/* AST_ELSEIF,*/ AST_ELSE, AST_IF_COND,
...
const char* const AST_NAMES[] = {"AST_PROG", "AST_PRE", "AST_VAR", "AST_VAR_IDS", "AST_VAR_DECL", "AST_DECL_ARRAY",
